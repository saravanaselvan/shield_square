...
module ShieldSquare
	...
	def self.shieldsquare_ValidateRequest( shieldsquare_username, shieldsquare_calltype, shieldsquare_pid, request, cookies ) 
		...
		shieldsquare_e = 5
		shieldsquare_f = 10
		shieldsquare_service_url = "http://" + Rails.configuration.shield_square[:$_ss2_domain] + "/getRequestData"
		$IP_ADDRESS = request.remote_ip
		
		if Rails.configuration.shield_square[:$_timeout_value] > 1000
		...
		if shieldsquare_calltype == 1 
			shieldsquare_pid = shieldsquare_generate_pid Rails.configuration.shield_square[:$_sid]
		else
		...
		$ShieldsquareRequest_zpsbd1 = Rails.configuration.shield_square[:$_sid]
		...
		$ShieldsquareResponse_url = Rails.configuration.shield_square[:$_js_url]

		if Rails.configuration.shield_square[:$_mode] == 'Active'
			shieldsquareCurlResponseCode=shieldsquare_post_sync shieldsquare_service_url, shieldsquare_json_obj,Rails.configuration.shield_square[:$_timeout_value]
			...
			if $_async_http_post == true
				asyncresponse=shieldsquare_post_async shieldsquare_service_url, shieldsquare_json_obj,Rails.configuration.shield_square[:$_timeout_value].to_s
				...
				syncresponse=shieldsquare_post_sync shieldsquare_service_url, shieldsquare_json_obj,Rails.configuration.shield_square[:$_timeout_value]
	...
	def self.shieldsquare_generate_pid(shieldsquare_sid)
		t=microtime
		dt=t.split(" ")
		p = Rails.configuration.shield_square[:$_sid].split("-")
		sid_min = p[3].to_i(16)
